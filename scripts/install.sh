...
# See https://github.com/microsoft/azure-pipelines-image-generation/blob/master/images/linux/ubuntu1804.json
...
./$SCRIPTS_DIR/installers/1804/basic.sh
...
./$SCRIPTS_DIR/installers/1804/dotnetcore-sdk.sh
...
# ./$SCRIPTS_DIR/installers/1804/go.sh
...
# ./$SCRIPTS_DIR/installers/kind.sh
# ./$SCRIPTS_DIR/installers/1804/kubernetes-tools.sh
# ./$SCRIPTS_DIR/installers/leiningen.sh
# ./$SCRIPTS_DIR/installers/1804/mercurial.sh
...
# ./$SCRIPTS_DIR/installers/1804/php.sh
# ./$SCRIPTS_DIR/installers/pollinate.sh
# ./$SCRIPTS_DIR/installers/1804/powershellcore.sh
# ./$SCRIPTS_DIR/installers/ruby.sh
# ./$SCRIPTS_DIR/installers/rust.sh
# ./$SCRIPTS_DIR/installers/sbt.sh
...
# ./$SCRIPTS_DIR/installers/1804/android.sh
# ./$SCRIPTS_DIR/installers/1804/azpowershell.sh
# ./$SCRIPTS_DIR/helpers/containercache.sh
# ./$SCRIPTS_DIR/installers/1804/hosted-tool-cache.sh
